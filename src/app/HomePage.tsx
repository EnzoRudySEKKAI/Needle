...
export function HomePage() {
  ...
  return <main className="home-page">
    ...
    <section className="home-hero"><div className="hero-copy"><h1>Build ideas<br />you can <i>walk through.</i></h1><p>Turn concepts, relations and scenarios into an isometric city. Every building has a deliberate form and size. Every street means something. Every moving signal follows a path you authored.</p><button type="button" className="primary-button" onClick={() => void createMap()}>Start with empty ground <span>→</span></button></div><div className="hero-diagram"><div className="diagram-grid" /><HeroMiniMap /></div></section>
