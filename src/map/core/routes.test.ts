...
function node(id: string, gx: number, gy: number): VisualNode {
  return { id, code: id, name: id, role: '', groupId: 'g', kind: 'concept', whatItDoes: '', howItsBuilt: '', metric: 1, unit: '', properties: [], position: { gx, gy }, faceTexture: 'plain', archetype: 'cube', footprint: { gx, gy, w: 2, d: 2 }, height: 2 }
}
