...
export const handler = createMcpHandler(() => {
  ...
  server.registerTool('add_node', {
    ...
    inputSchema: z.object({
      ...
      archetype: z.enum(['cube','tower','low-slab','slab-stack','fin-row','podium-tower','twin-towers','courtyard','bridge','stepped-pyramid','server-rack','monitor','camera','database']).optional(),
  ...
  server.registerTool('update_node', {
    ...
    inputSchema: z.object({
      ...
      patch: z.object({
        ...
        whatItDoes: z.string().optional(),
        howItsBuilt: z.string().optional(),
        archetype: z.enum(['cube','tower','low-slab','slab-stack','fin-row','podium-tower','twin-towers','courtyard','bridge','stepped-pyramid','server-rack','monitor','camera','database']).nullable().optional().describe('null to clear override'),
